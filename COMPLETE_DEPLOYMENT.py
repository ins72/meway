...
Handles MongoDB installation, startup, and application deployment
"""
...
def start_mongodb():
    ...
    success, stdout, stderr = run_command(f"mongod --dbpath {data_dir} --port 27017")
    if success:
...
def create_working_app():
    ...
    print("🔧 Creating working application...")
...
'''
    ...
    print("✅ Working application created")

def install_dependencies():
    """Install Python dependencies"""
    print("📦 Installing Python dependencies...")
    success, stdout, stderr = run_command("pip install fastapi uvicorn motor pymongo pydantic")
    if success:
...
def main():
    ...
    print("🚀 COMPLETE MEWAYZ DEPLOYMENT")
    print("=" * 50)
    ...
    # Step 4: Create working app
    print("\n4️⃣ Creating working application...")
    create_working_app()
    ...
    success, stdout, stderr = run_command("python app.py")
    
    if success:
        print("✅ Application started successfully!")
        
        # Step 8: Test endpoints
        print("\n8️⃣ Testing endpoints...")
        test_endpoints()
