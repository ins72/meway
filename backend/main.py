...
try:
    ...
    from api.onboarding_progress import router as onboarding_progress_router
    ...
    from api.enhanced_stripe import router as enhanced_stripe_router
    ...
    app.include_router(onboarding_progress_router, prefix="/api/onboarding", tags=["onboarding_progress"])
    ...
    app.include_router(template_marketplace_access_router, prefix="/api/template-marketplace-access", tags=["template_marketplace_access"])
    app.include_router(ai_token_purchase_router, prefix="/api/ai-token-purchase", tags=["ai_token_purchase"])
