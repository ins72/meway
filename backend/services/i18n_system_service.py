...
class I18nSystemService:
    """Service class for I18nSystemService operations"""
    def __init__(self):
        self.service_name = "i18n_system"
        self.collection_name = "i18nsystem"
    ...
    async def create_i18n_system(self, data: dict) -> dict:
    ...
    async def get_i18n_system(self, item_id: str) -> dict:
    ...
    async def list_i18n_systems(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_i18n_system(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_i18n_system(self, item_id: str) -> dict:
...
def get_i18n_system_service():
    ...
    if _service_instance is None:
        _service_instance = I18nSystemService()
