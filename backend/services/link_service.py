...
class LinkService:
    """Service class for LinkService operations"""
    def __init__(self):
        self.service_name = "link"
    ...
    async def create_link(self, data: dict) -> dict:
    ...
    async def get_link(self, item_id: str) -> dict:
    ...
    async def list_links(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_link(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_link(self, item_id: str) -> dict:
