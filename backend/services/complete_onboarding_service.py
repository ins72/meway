...
class CompleteOnboardingService:
    """Service class for CompleteOnboardingService operations"""
    def __init__(self):
        self.service_name = "complete_onboarding"
        self.collection_name = "completeonboarding"
    ...
    async def create_complete_onboarding(self, data: dict) -> dict:
    ...
    async def get_complete_onboarding(self, item_id: str) -> dict:
    ...
    async def list_complete_onboardings(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_complete_onboarding(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_complete_onboarding(self, item_id: str) -> dict:
...
def get_complete_onboarding_service():
    ...
    if _service_instance is None:
        _service_instance = CompleteOnboardingService()
