...
class DashboardService:
    ...
    async def create_dashboard(self, data: dict) -> dict:
    ...
    async def get_dashboard(self, item_id: str) -> dict:
    ...
    async def list_dashboards(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_dashboard(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_dashboard(self, item_id: str) -> dict:
