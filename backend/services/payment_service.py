...
class PaymentService:
    """Service class for PaymentService operations"""
    def __init__(self):
        self.service_name = "payment"
        self.collection_name = "payment"
    ...
    async def get_payment(self, item_id: str) -> dict:
    ...
    async def update_payment(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_payment(self, item_id: str) -> dict:
...
def get_payment_service():
    ...
    if _service_instance is None:
        _service_instance = PaymentService()
