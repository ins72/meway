...
class AdminConfigurationService:
    ...
    async def create_admin_configuration(self, data: dict) -> dict:
    ...
    async def get_admin_configuration(self, item_id: str) -> dict:
    ...
    async def list_admin_configurations(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_admin_configuration(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_admin_configuration(self, item_id: str) -> dict:
...
def get_admin_configuration_service():
    ...
    if _service_instance is None:
        _service_instance = AdminConfigurationService()
