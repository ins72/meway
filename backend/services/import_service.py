...
class ImportService:
    """Service class for ImportService operations"""
    def __init__(self):
        self.service_name = "import"
        self.collection_name = "import"
    ...
    async def create_import(self, data: dict) -> dict:
    ...
    async def get_import(self, item_id: str) -> dict:
    ...
    async def list_imports(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_import(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_import(self, item_id: str) -> dict:
...
def get_import_service():
    ...
    if _service_instance is None:
        _service_instance = ImportService()
