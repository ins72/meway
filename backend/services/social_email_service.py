...
class SocialEmailService:
    """Service class for SocialEmailService operations"""
    def __init__(self):
        self.service_name = "social_email"
        self.collection_name = "socialemail"
    ...
    async def create_social_email(self, data: dict) -> dict:
    ...
    async def get_social_email(self, item_id: str) -> dict:
    ...
    async def list_social_emails(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_social_email(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_social_email(self, item_id: str) -> dict:
...
def get_social_email_service():
    ...
    if _service_instance is None:
        _service_instance = SocialEmailService()
