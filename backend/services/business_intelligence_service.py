...
class BusinessIntelligenceService:
    """Service class for BusinessIntelligenceService operations"""
    def __init__(self):
        self.service_name = "business_intelligence"
        self.collection_name = "businessintelligence"
    ...
    def _get_collection(self):
        ...
        try:
            ...
            if db is None:
                ...
                return None
            return db["business_intelligence"]
    ...
    async def create_business_intelligence(self, data: dict) -> dict:
    ...
    async def get_business_intelligence(self, item_id: str) -> dict:
    ...
    async def list_business_intelligences(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_business_intelligence(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_business_intelligence(self, item_id: str) -> dict:
...
def get_business_intelligence_service():
    ...
    if _service_instance is None:
        _service_instance = BusinessIntelligenceService()
