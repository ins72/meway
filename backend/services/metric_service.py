...
class MetricService:
    """Service class for MetricService operations"""
    def __init__(self):
        self.service_name = "metric"
        self.collection_name = "metric"
    ...
    async def create_metric(self, data: dict) -> dict:
    ...
    async def get_metric(self, item_id: str) -> dict:
    ...
    async def list_metrics(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_metric(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_metric(self, item_id: str) -> dict:
...
def get_metric_service():
    ...
    if _service_instance is None:
        _service_instance = MetricService()
