...
class WebhookSystemService:
    """Service class for WebhookSystemService operations"""
    def __init__(self):
        self.service_name = "webhook_system"
        self.collection_name = "webhooksystem"
    ...
    async def create_webhook_system(self, data: dict) -> dict:
    ...
    async def get_webhook_system(self, item_id: str) -> dict:
    ...
    async def list_webhook_systems(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_webhook_system(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_webhook_system(self, item_id: str) -> dict:
...
def get_webhook_system_service():
    ...
    if _service_instance is None:
        _service_instance = WebhookSystemService()
