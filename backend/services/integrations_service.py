...
class IntegrationsService:
    ...
    async def create_integrations(self, data: dict) -> dict:
    ...
    async def get_integrations(self, item_id: str) -> dict:
    ...
    async def list_integrationss(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_integrations(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_integrations(self, item_id: str) -> dict:
