...
class MobilePwaFeaturesService:
    """Service class for MobilePwaFeaturesService operations"""
    def __init__(self):
        self.service_name = "mobile_pwa_features"
        self.collection_name = "mobilepwafeatures"
    ...
    async def create_mobile_pwa_features(self, data: dict) -> dict:
    ...
    async def get_mobile_pwa_features(self, item_id: str) -> dict:
    ...
    async def list_mobile_pwa_featuress(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_mobile_pwa_features(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_mobile_pwa_features(self, item_id: str) -> dict:
