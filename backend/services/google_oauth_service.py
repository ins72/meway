...
class GoogleOauthService:
    """Service class for GoogleOauthService operations"""
    def __init__(self):
        self.service_name = "google_oauth"
        self.collection_name = "googleoauth"
    ...
    async def create_google_oauth(self, data: dict) -> dict:
    ...
    async def get_google_oauth(self, item_id: str) -> dict:
    ...
    async def list_google_oauths(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_google_oauth(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_google_oauth(self, item_id: str) -> dict:
