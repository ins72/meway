...
class SupportSystemService:
    """Service class for SupportSystemService operations"""
    def __init__(self):
        self.service_name = "support_system"
        self.collection_name = "supportsystem"
    ...
    async def create_support_system(self, data: dict) -> dict:
    ...
    async def get_support_system(self, item_id: str) -> dict:
    ...
    async def list_support_systems(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_support_system(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_support_system(self, item_id: str) -> dict:
...
def get_support_system_service():
    ...
    if _service_instance is None:
        _service_instance = SupportSystemService()
