...
class CourseManagementService:
    """Service class for CourseManagementService operations"""
    def __init__(self):
        self.service_name = "course_management"
        self.collection_name = "coursemanagement"
    ...
    async def create_course_management(self, data: dict) -> dict:
    ...
    async def get_course_management(self, item_id: str) -> dict:
    ...
    async def list_course_managements(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_course_management(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_course_management(self, item_id: str) -> dict:
