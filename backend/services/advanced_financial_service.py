...
class AdvancedFinancialService:
    ...
    async def create_advanced_financial(self, data: dict) -> dict:
    ...
    async def get_advanced_financial(self, item_id: str) -> dict:
    ...
    async def list_advanced_financials(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_advanced_financial(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_advanced_financial(self, item_id: str) -> dict:
