...
class FormBuilderService:
    """Service class for FormBuilderService operations"""
    def __init__(self):
        self.service_name = "form_builder"
        self.collection_name = "formbuilder"
    ...
    async def create_form_builder(self, data: dict) -> dict:
    ...
    async def get_form_builder(self, item_id: str) -> dict:
    ...
    async def list_form_builders(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_form_builder(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_form_builder(self, item_id: str) -> dict:
...
def get_form_builder_service():
    ...
    if _service_instance is None:
        _service_instance = FormBuilderService()
