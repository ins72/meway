...
class CrmManagementService:
    ...
    async def create_crm_management(self, data: dict) -> dict:
    ...
    async def get_crm_management(self, item_id: str) -> dict:
    ...
    async def list_crm_managements(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_crm_management(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_crm_management(self, item_id: str) -> dict:
...
def get_crm_management_service():
    ...
    if _service_instance is None:
        _service_instance = CrmManagementService()
