...
class SubscriptionService:
    ...
    async def get_subscription(self, item_id: str) -> dict:
    ...
    async def list_subscriptions(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_subscription(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_subscription(self, item_id: str) -> dict:
