...
class EnhancedFeaturesService:
    """Service class for EnhancedFeaturesService operations"""
    def __init__(self):
        self.service_name = "enhanced_features"
        self.collection_name = "enhancedfeatures"
    ...
    async def create_enhanced_features(self, data: dict) -> dict:
    ...
    async def get_enhanced_features(self, item_id: str) -> dict:
    ...
    async def list_enhanced_featuress(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_enhanced_features(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_enhanced_features(self, item_id: str) -> dict:
...
def get_enhanced_features_service():
    """Get service instance"""
    global _service_instance
    if _service_instance is None:
        _service_instance = EnhancedFeaturesService()
    return _service_instance

# Backward compatibility
enhanced_features_service = get_enhanced_features_service()