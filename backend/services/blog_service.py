...
class BlogService:
    """Service class for BlogService operations"""
    def __init__(self):
        self.service_name = "blog"
    ...
    async def create_blog(self, data: dict) -> dict:
    ...
    async def get_blog(self, item_id: str) -> dict:
    ...
    async def list_blogs(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_blog(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_blog(self, item_id: str) -> dict:
