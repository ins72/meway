...
class AutomationService:
    """Service class for AutomationService operations"""
    def __init__(self):
    ...
    async def create_automation(self, data: dict) -> dict:
    ...
    async def get_automation(self, item_id: str) -> dict:
    ...
    async def list_automations(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_automation(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_automation(self, item_id: str) -> dict:
