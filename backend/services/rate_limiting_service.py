...
class RateLimitingService:
    """Service class for RateLimitingService operations"""
    def __init__(self):
        self.service_name = "rate_limiting"
        self.collection_name = "ratelimiting"
    ...
    async def create_rate_limiting(self, data: dict) -> dict:
    ...
    async def get_rate_limiting(self, item_id: str) -> dict:
    ...
    async def list_rate_limitings(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_rate_limiting(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_rate_limiting(self, item_id: str) -> dict:
...
def get_rate_limiting_service():
    ...
    if _service_instance is None:
        _service_instance = RateLimitingService()
