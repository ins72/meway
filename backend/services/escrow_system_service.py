...
class EscrowSystemService:
    """Service class for EscrowSystemService operations"""
    def __init__(self):
        self.service_name = "escrow_system"
        self.collection_name = "escrowsystem"
    ...
    async def create_escrow_system(self, data: dict) -> dict:
    ...
    async def get_escrow_system(self, item_id: str) -> dict:
    ...
    async def list_escrow_systems(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_escrow_system(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_escrow_system(self, item_id: str) -> dict:
...
def get_escrow_system_service():
    """Get service instance"""
    global _service_instance
    if _service_instance is None:
        _service_instance = EscrowSystemService()
    return _service_instance

# Backward compatibility
escrow_system_service = get_escrow_system_service()