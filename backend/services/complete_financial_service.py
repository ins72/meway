...
class CompleteFinancialService:
    """Service class for CompleteFinancialService operations"""
    def __init__(self):
        self.service_name = "complete_financial"
        self.collection_name = "completefinancial"
    ...
    async def create_complete_financial(self, data: dict) -> dict:
    ...
    async def get_complete_financial(self, item_id: str) -> dict:
    ...
    async def list_complete_financials(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_complete_financial(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_complete_financial(self, item_id: str) -> dict:
...
def get_complete_financial_service():
    ...
    if _service_instance is None:
        _service_instance = CompleteFinancialService()
