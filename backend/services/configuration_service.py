...
class ConfigurationService:
    """Service class for ConfigurationService operations"""
    def __init__(self):
        self.service_name = "configuration"
    ...
    async def create_configuration(self, data: dict) -> dict:
    ...
    async def get_configuration(self, item_id: str) -> dict:
    ...
    async def list_configurations(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_configuration(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_configuration(self, item_id: str) -> dict:
...
def get_configuration_service():
    ...
    if _service_instance is None:
        _service_instance = ConfigurationService()
