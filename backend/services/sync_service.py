...
class SyncService:
    ...
    def __init__(self):
        self.service_name = "sync"
        self.collection_name = "sync"
    ...
    async def create_sync(self, data: dict) -> dict:
    ...
    async def get_sync(self, item_id: str) -> dict:
    ...
    async def list_syncs(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_sync(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_sync(self, item_id: str) -> dict:
