...
class ContentCreationSuiteService:
    """Service class for ContentCreationSuiteService operations"""
    def __init__(self):
        self.service_name = "content_creation_suite"
        self.collection_name = "contentcreationsuite"
    ...
    def _get_collection(self):
        ...
        try:
            ...
            if db is None:
                ...
                return None
            return db["content_creation_suite"]
    ...
    async def create_content_creation_suite(self, data: dict) -> dict:
    ...
    async def get_content_creation_suite(self, item_id: str) -> dict:
    ...
    async def list_content_creation_suites(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_content_creation_suite(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_content_creation_suite(self, item_id: str) -> dict:
...
def get_content_creation_suite_service():
    ...
    if _service_instance is None:
        _service_instance = ContentCreationSuiteService()
