...
class I18nService:
    """Service class for I18nService operations"""
    def __init__(self):
        self.service_name = "i18n"
        self.collection_name = "i18n"
    ...
    async def create_i18n(self, data: dict) -> dict:
    ...
    async def get_i18n(self, item_id: str) -> dict:
    ...
    async def list_i18ns(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_i18n(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_i18n(self, item_id: str) -> dict:
