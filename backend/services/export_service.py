...
class ExportService:
    """Service class for ExportService operations"""
    def __init__(self):
        self.service_name = "export"
        self.collection_name = "export"
    ...
    async def create_export(self, data: dict) -> dict:
    ...
    async def get_export(self, item_id: str) -> dict:
    ...
    async def list_exports(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_export(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_export(self, item_id: str) -> dict:
