...
class TeamService:
    """Service class for TeamService operations"""
    def __init__(self):
    ...
    async def get_team(self, item_id: str) -> dict:
    ...
    async def list_teams(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_team(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_team(self, item_id: str) -> dict:
