...
class ComplianceService:
    """Service class for ComplianceService operations"""
    def __init__(self):
    ...
    async def create_compliance(self, data: dict) -> dict:
    ...
    async def get_compliance(self, item_id: str) -> dict:
    ...
    async def list_compliances(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_compliance(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_compliance(self, item_id: str) -> dict:
