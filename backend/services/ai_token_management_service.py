...
class AiTokenManagementService:
    """Service class for AiTokenManagementService operations"""
    def __init__(self):
        self.service_name = "ai_token_management"
        self.collection_name = "aitokenmanagement"
    ...
    async def create_ai_token_management(self, data: dict) -> dict:
    ...
    async def get_ai_token_management(self, item_id: str) -> dict:
    ...
    async def list_ai_token_managements(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_ai_token_management(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_ai_token_management(self, item_id: str) -> dict:
...
def get_ai_token_management_service():
    ...
    if _service_instance is None:
        _service_instance = AiTokenManagementService()
