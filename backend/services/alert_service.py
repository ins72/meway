...
class AlertService:
    """Service class for AlertService operations"""
    def __init__(self):
        self.service_name = "alert"
        self.collection_name = "alert"
    ...
    async def get_alert(self, item_id: str) -> dict:
    ...
    async def list_alerts(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_alert(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_alert(self, item_id: str) -> dict:
