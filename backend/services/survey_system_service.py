...
class SurveySystemService:
    """Service class for SurveySystemService operations"""
    def __init__(self):
        self.service_name = "survey_system"
        self.collection_name = "surveysystem"
    ...
    async def create_survey_system(self, data: dict) -> dict:
    ...
    async def get_survey_system(self, item_id: str) -> dict:
    ...
    async def list_survey_systems(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_survey_system(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_survey_system(self, item_id: str) -> dict:
...
def get_survey_system_service():
    ...
    if _service_instance is None:
        _service_instance = SurveySystemService()
