...
class NotificationService:
    def __init__(self):
        ...
        self.collection_name = "notification"
        self.db = None
    ...
    async def create_notification(self, data: Dict[str, Any], user_id: str = None) -> Dict[str, Any]:
        """Create new notification with comprehensive validation and real data storage"""
        try:
            # Validate input
    ...
    async def get_notification(self, item_id: str, user_id: str = None) -> Dict[str, Any]:
    ...
    async def list_notifications(self, user_id: str = None, limit: int = 50, offset: int = 0, 
                                  filters: Dict[str, Any] = None, sort_by: str = "created_at",
                                  sort_order: int = -1) -> Dict[str, Any]:
        """List notifications with comprehensive filtering, pagination, and sorting"""
        try:
            # Validate parameters
    ...
    async def update_notification(self, item_id: str, update_data: Dict[str, Any], 
                                   user_id: str = None) -> Dict[str, Any]:
        """Update notification with comprehensive validation and real data storage"""
        try:
            if not item_id:
                return {"success": False, "error": "ID is required"}
    ...
    async def delete_notification(self, item_id: str, user_id: str = None, 
                                   soft_delete: bool = True) -> Dict[str, Any]:
        """Delete notification with comprehensive validation (soft delete by default)"""
        try:
            if not item_id:
                return {"success": False, "error": "ID is required"}
    ...
    async def search_notifications(self, search_query: str, user_id: str = None, 
                                    limit: int = 50, offset: int = 0) -> Dict[str, Any]:
        """Search notifications with text search capabilities"""
        try:
            if not search_query:
    ...
    async def bulk_create_notifications(self, items: List[Dict[str, Any]], 
                                         user_id: str = None) -> Dict[str, Any]:
