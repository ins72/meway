...
class CompleteSubscriptionService:
    """Service class for CompleteSubscriptionService operations"""
    def __init__(self):
        self.service_name = "complete_subscription"
        self.collection_name = "completesubscription"
    ...
    def _get_collection(self):
        ...
        try:
            ...
            if db is None:
                ...
                return None
            return db["complete_subscription"]
    ...
    async def create_complete_subscription(self, data: dict) -> dict:
    ...
    async def get_complete_subscription(self, item_id: str) -> dict:
    ...
    async def list_complete_subscriptions(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_complete_subscription(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_complete_subscription(self, item_id: str) -> dict:
...
def get_complete_subscription_service():
    ...
    if _service_instance is None:
        _service_instance = CompleteSubscriptionService()
