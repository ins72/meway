...
class CompleteBookingService:
    """Service class for CompleteBookingService operations"""
    def __init__(self):
        self.service_name = "complete_booking"
        self.collection_name = "completebooking"
    ...
    async def create_complete_booking(self, data: dict) -> dict:
    ...
    async def get_complete_booking(self, item_id: str) -> dict:
    ...
    async def list_complete_bookings(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_complete_booking(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_complete_booking(self, item_id: str) -> dict:
...
def get_complete_booking_service():
    ...
    if _service_instance is None:
        _service_instance = CompleteBookingService()
