...
class SupportService:
    """Service class for SupportService operations"""
    def __init__(self):
    ...
    async def create_support(self, data: dict) -> dict:
    ...
    async def get_support(self, item_id: str) -> dict:
    ...
    async def list_supports(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_support(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_support(self, item_id: str) -> dict:
