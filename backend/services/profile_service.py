...
class ProfileService:
    ...
    async def get_profile(self, item_id: str) -> dict:
    ...
    async def list_profiles(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_profile(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_profile(self, item_id: str) -> dict:
