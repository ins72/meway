...
class SecurityService:
    """Service class for SecurityService operations"""
    def __init__(self):
        self.service_name = "security"
    ...
    async def create_security(self, data: dict) -> dict:
    ...
    async def get_security(self, item_id: str) -> dict:
    ...
    async def list_securitys(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_security(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_security(self, item_id: str) -> dict:
