...
class MonitoringSystemService:
    """Service class for MonitoringSystemService operations"""
    def __init__(self):
        self.service_name = "monitoring_system"
        self.collection_name = "monitoringsystem"
    ...
    async def create_monitoring_system(self, data: dict) -> dict:
    ...
    async def get_monitoring_system(self, item_id: str) -> dict:
    ...
    async def list_monitoring_systems(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_monitoring_system(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_monitoring_system(self, item_id: str) -> dict:
...
def get_monitoring_system_service():
    ...
    if _service_instance is None:
        _service_instance = MonitoringSystemService()
