...
class ContentService:
    """Service class for ContentService operations"""
    def __init__(self):
    ...
    async def list_contents(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_content(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_content(self, item_id: str) -> dict:
