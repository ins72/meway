...
class CompleteEscrowService:
    """Service class for CompleteEscrowService operations"""
    def __init__(self):
        self.service_name = "complete_escrow"
        self.collection_name = "completeescrow"
    ...
    async def create_complete_escrow(self, data: dict) -> dict:
    ...
    async def get_complete_escrow(self, item_id: str) -> dict:
    ...
    async def list_complete_escrows(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_complete_escrow(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_complete_escrow(self, item_id: str) -> dict:
...
def get_complete_escrow_service():
    ...
    if _service_instance is None:
        _service_instance = CompleteEscrowService()
