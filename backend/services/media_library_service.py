...
class MediaLibraryService:
    ...
    async def create_media_library(self, data: dict) -> dict:
    ...
    async def get_media_library(self, item_id: str) -> dict:
    ...
    async def list_media_librarys(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_media_library(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_media_library(self, item_id: str) -> dict:
