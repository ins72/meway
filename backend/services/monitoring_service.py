...
class MonitoringService:
    ...
    async def create_monitoring(self, data: dict) -> dict:
    ...
    async def get_monitoring(self, item_id: str) -> dict:
    ...
    async def list_monitorings(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_monitoring(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_monitoring(self, item_id: str) -> dict:
