...
class CustomerExperienceSuiteService:
    """Service class for CustomerExperienceSuiteService operations"""
    def __init__(self):
        self.service_name = "customer_experience_suite"
        self.collection_name = "customerexperiencesuite"
    ...
    def _get_collection(self):
        ...
        try:
            ...
            if db is None:
                ...
                return None
            return db["customer_experience_suite"]
    ...
    async def create_customer_experience_suite(self, data: dict) -> dict:
    ...
    async def get_customer_experience_suite(self, item_id: str) -> dict:
    ...
    async def list_customer_experience_suites(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_customer_experience_suite(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_customer_experience_suite(self, item_id: str) -> dict:
...
def get_customer_experience_suite_service():
    ...
    if _service_instance is None:
        _service_instance = CustomerExperienceSuiteService()
