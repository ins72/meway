...
class BackupService:
    """Service class for BackupService operations"""
    def __init__(self):
    ...
    async def create_backup(self, data: dict) -> dict:
    ...
    async def get_backup(self, item_id: str) -> dict:
    ...
    async def list_backups(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_backup(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_backup(self, item_id: str) -> dict:
