...
class BackupSystemService:
    """Service class for BackupSystemService operations"""
    def __init__(self):
        self.service_name = "backup_system"
        self.collection_name = "backupsystem"
    ...
    async def create_backup_system(self, data: dict) -> dict:
    ...
    async def get_backup_system(self, item_id: str) -> dict:
    ...
    async def list_backup_systems(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_backup_system(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_backup_system(self, item_id: str) -> dict:
...
def get_backup_system_service():
    """Get service instance"""
    global _service_instance
    if _service_instance is None:
        _service_instance = BackupSystemService()
    return _service_instance

# Backward compatibility
backup_system_service = get_backup_system_service()