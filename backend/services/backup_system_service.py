"""
backup_system Service
Provides business logic for Backup System
"""
...
class BackupSystemService:
    """Service class for Backup System"""
    
    def __init__(self):
        self.db = get_database()
        self.collection = self.db["backup_system"]
...
# Service instance
backup_system_service = BackupSystemService()
