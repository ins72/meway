...
class IntegrationTestsService:
    """Service class for IntegrationTestsService operations"""
    def __init__(self):
        self.service_name = "integration_tests"
        self.collection_name = "integrationtests"
    ...
    async def create_integration_tests(self, data: dict) -> dict:
    ...
    async def get_integration_tests(self, item_id: str) -> dict:
    ...
    async def list_integration_testss(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_integration_tests(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_integration_tests(self, item_id: str) -> dict:
