...
class CompleteReferralSystemService:
    """Service class for CompleteReferralSystemService operations"""
    def __init__(self):
        self.service_name = "complete_referral_system"
        self.collection_name = "completereferralsystem"
    ...
    def _get_collection(self):
        ...
        try:
            ...
            if db is None:
                ...
                return None
            return db["complete_referral_system"]
    ...
    async def create_complete_referral_system(self, data: dict) -> dict:
    ...
    async def get_complete_referral_system(self, item_id: str) -> dict:
    ...
    async def list_complete_referral_systems(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_complete_referral_system(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_complete_referral_system(self, item_id: str) -> dict:
...
def get_complete_referral_system_service():
    ...
    if _service_instance is None:
        _service_instance = CompleteReferralSystemService()
