...
class AutomationSystemService:
    """Service class for AutomationSystemService operations"""
    def __init__(self):
        self.service_name = "automation_system"
        self.collection_name = "automationsystem"
    ...
    async def create_automation_system(self, data: dict) -> dict:
    ...
    async def get_automation_system(self, item_id: str) -> dict:
    ...
    async def list_automation_systems(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_automation_system(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_automation_system(self, item_id: str) -> dict:
...
def get_automation_system_service():
    ...
    if _service_instance is None:
        _service_instance = AutomationSystemService()
