...
class LinkShortenerService:
    ...
    async def create_link_shortener(self, data: dict) -> dict:
    ...
    async def get_link_shortener(self, item_id: str) -> dict:
    ...
    async def list_link_shorteners(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_link_shortener(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_link_shortener(self, item_id: str) -> dict:
...
def get_link_shortener_service():
    ...
    if _service_instance is None:
        _service_instance = LinkShortenerService()
