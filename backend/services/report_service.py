...
class ReportService:
    """Service class for ReportService operations"""
    def __init__(self):
    ...
    async def get_report(self, item_id: str) -> dict:
    ...
    async def list_reports(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_report(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_report(self, item_id: str) -> dict:
