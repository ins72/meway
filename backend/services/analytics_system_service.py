...
class AnalyticsSystemService:
    """Service class for AnalyticsSystemService operations"""
    def __init__(self):
        self.service_name = "analytics_system"
        self.collection_name = "analyticssystem"
    ...
    async def create_analytics_system(self, data: dict) -> dict:
    ...
    async def get_analytics_system(self, item_id: str) -> dict:
    ...
    async def list_analytics_systems(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_analytics_system(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_analytics_system(self, item_id: str) -> dict:
...
def get_analytics_system_service():
    """Get service instance"""
    global _service_instance
    if _service_instance is None:
        _service_instance = AnalyticsSystemService()
    return _service_instance

# Backward compatibility
analytics_system_service = get_analytics_system_service()