...
class DataPopulationService:
    def __init__(self):
        self.service_name = "data_population"
        self.collection_name = "datapopulation"
    ...
    async def create_data_population(self, data: dict) -> dict:
    ...
    async def get_data_population(self, item_id: str) -> dict:
    ...
    async def list_data_populations(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_data_population(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_data_population(self, item_id: str) -> dict:
