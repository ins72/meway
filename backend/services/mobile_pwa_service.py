...
class MobilePwaService:
    """Service class for MobilePwaService operations"""
    def __init__(self):
        self.service_name = "mobile_pwa"
        self.collection_name = "mobilepwa"
    ...
    async def create_mobile_pwa(self, data: dict) -> dict:
    ...
    async def get_mobile_pwa(self, item_id: str) -> dict:
    ...
    async def list_mobile_pwas(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_mobile_pwa(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_mobile_pwa(self, item_id: str) -> dict:
...
def get_mobile_pwa_service():
    ...
    if _service_instance is None:
        _service_instance = MobilePwaService()
