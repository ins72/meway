...
class AiService:
    """Service class for AiService operations"""
    def __init__(self):
        self.service_name = "ai"
        self.collection_name = "ai"
    ...
    async def create_ai(self, data: dict) -> dict:
    ...
    async def get_ai(self, item_id: str) -> dict:
    ...
    async def list_ais(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_ai(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_ai(self, item_id: str) -> dict:
