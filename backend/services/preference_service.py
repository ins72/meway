...
class PreferenceService:
    """Service class for PreferenceService operations"""
    def __init__(self):
        self.service_name = "preference"
        self.collection_name = "preference"
    ...
    async def create_preference(self, data: dict) -> dict:
    ...
    async def get_preference(self, item_id: str) -> dict:
    ...
    async def list_preferences(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_preference(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_preference(self, item_id: str) -> dict:
...
def get_preference_service():
    ...
    if _service_instance is None:
        _service_instance = PreferenceService()
