...
class SettingsService:
    ...
    async def create_settings(self, data: dict) -> dict:
    ...
    async def get_settings(self, item_id: str) -> dict:
    ...
    async def list_settingss(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_settings(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_settings(self, item_id: str) -> dict:
