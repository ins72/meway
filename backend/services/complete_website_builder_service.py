...
class CompleteWebsiteBuilderService:
    """Service class for CompleteWebsiteBuilderService operations"""
    def __init__(self):
        self.service_name = "complete_website_builder"
        self.collection_name = "completewebsitebuilder"
    ...
    def _get_collection(self):
        ...
        try:
            ...
            if db is None:
                ...
                return None
            return db["complete_website_builder"]
    ...
    async def create_complete_website_builder(self, data: dict) -> dict:
    ...
    async def get_complete_website_builder(self, item_id: str) -> dict:
    ...
    async def list_complete_website_builders(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_complete_website_builder(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_complete_website_builder(self, item_id: str) -> dict:
...
def get_complete_website_builder_service():
    ...
    if _service_instance is None:
        _service_instance = CompleteWebsiteBuilderService()
