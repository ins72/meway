...
class AiContentService:
    """Service class for AiContentService operations"""
    def __init__(self):
    ...
    async def create_ai_content(self, data: dict) -> dict:
    ...
    async def get_ai_content(self, item_id: str) -> dict:
    ...
    async def list_ai_contents(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_ai_content(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_ai_content(self, item_id: str) -> dict:
