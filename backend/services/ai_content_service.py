...
class AiContentService:
    def __init__(self):
        self.service_name = "ai_content"
        self.collection_name = "aicontent"
        self.db = None
    ...
    async def create_ai_content(self, data: Dict[str, Any], user_id: str = None) -> Dict[str, Any]:
        """Create new ai_content with comprehensive validation and real data storage"""
        try:
            # Validate input
    ...
    async def get_ai_content(self, item_id: str, user_id: str = None) -> Dict[str, Any]:
    ...
    async def list_ai_contents(self, user_id: str = None, limit: int = 50, offset: int = 0, 
                                  filters: Dict[str, Any] = None, sort_by: str = "created_at",
                                  sort_order: int = -1) -> Dict[str, Any]:
        """List ai_contents with comprehensive filtering, pagination, and sorting"""
        try:
            # Validate parameters
    ...
    async def update_ai_content(self, item_id: str, update_data: Dict[str, Any], 
                                   user_id: str = None) -> Dict[str, Any]:
        """Update ai_content with comprehensive validation and real data storage"""
        try:
            if not item_id:
                return {"success": False, "error": "ID is required"}
    ...
    async def delete_ai_content(self, item_id: str, user_id: str = None, 
                                   soft_delete: bool = True) -> Dict[str, Any]:
        """Delete ai_content with comprehensive validation (soft delete by default)"""
        try:
            if not item_id:
                return {"success": False, "error": "ID is required"}
    ...
    async def search_ai_contents(self, search_query: str, user_id: str = None, 
                                    limit: int = 50, offset: int = 0) -> Dict[str, Any]:
        """Search ai_contents with text search capabilities"""
        try:
            if not search_query:
    ...
    async def bulk_create_ai_contents(self, items: List[Dict[str, Any]], 
                                         user_id: str = None) -> Dict[str, Any]:
...
def get_ai_content_service():
    ...
    if _service_instance is None:
        _service_instance = AiContentService()
