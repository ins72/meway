...
class MediaService:
    ...
    async def get_media(self, item_id: str) -> dict:
    ...
    async def list_medias(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_media(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_media(self, item_id: str) -> dict:
