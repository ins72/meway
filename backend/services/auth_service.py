...
class AuthService:
    ...
    async def create_auth(self, data: dict) -> dict:
    ...
    async def get_auth(self, item_id: str) -> dict:
    ...
    async def list_auths(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_auth(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_auth(self, item_id: str) -> dict:
