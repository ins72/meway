...
class AdvancedTemplateMarketplaceService:
    """Service class for AdvancedTemplateMarketplaceService operations"""
    def __init__(self):
        self.service_name = "advanced_template_marketplace"
        self.collection_name = "advancedtemplatemarketplace"
    ...
    def _get_collection(self):
        ...
        try:
            ...
            if db is None:
                ...
                return None
            return db["advanced_template_marketplace"]
    ...
    async def create_advanced_template_marketplace(self, data: dict) -> dict:
    ...
    async def get_advanced_template_marketplace(self, item_id: str) -> dict:
    ...
    async def list_advanced_template_marketplaces(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_advanced_template_marketplace(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_advanced_template_marketplace(self, item_id: str) -> dict:
...
def get_advanced_template_marketplace_service():
    ...
    if _service_instance is None:
        _service_instance = AdvancedTemplateMarketplaceService()
