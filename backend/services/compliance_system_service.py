...
class ComplianceSystemService:
    ...
    def __init__(self):
        self.service_name = "compliance_system"
        self.collection_name = "compliancesystem"
    ...
    async def create_compliance_system(self, data: dict) -> dict:
    ...
    async def get_compliance_system(self, item_id: str) -> dict:
    ...
    async def list_compliance_systems(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_compliance_system(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_compliance_system(self, item_id: str) -> dict:
