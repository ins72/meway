...
class BioSitesService:
    """Service class for BioSitesService operations"""
    def __init__(self):
        self.service_name = "bio_sites"
        self.collection_name = "biosites"
    ...
    async def create_bio_sites(self, data: dict) -> dict:
    ...
    async def get_bio_sites(self, item_id: str) -> dict:
    ...
    async def list_bio_sitess(self, user_id: str = None, limit: int = 50, offset: int = 0) -> dict:
    ...
    async def update_bio_sites(self, item_id: str, update_data: dict) -> dict:
    ...
    async def delete_bio_sites(self, item_id: str) -> dict:
...
def get_bio_sites_service():
    ...
    if _service_instance is None:
        _service_instance = BioSitesService()
