...
async def create_booking(
    data: Dict[str, Any] = Body({}, description="Data for creating booking"),
...
async def get_booking(
    item_id: str = Path(..., description="ID of booking"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_booking_service()
        result = await service.get_booking(item_id)
...
async def update_booking(
    ...
    try:
        ...
        service = get_booking_service()
        result = await service.update_booking(item_id, data)
...
async def delete_booking(
    ...
    try:
        service = get_booking_service()
        result = await service.delete_booking(item_id)
