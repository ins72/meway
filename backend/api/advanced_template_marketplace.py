...
from services.advanced_template_marketplace_service import get_advanced_template_marketplace_service
import logging
...
async def health_check():
    ...
    try:
        service = get_advanced_template_marketplace_service()
...
@router.post("/")
async def create_advanced_template_marketplace(
    data: Dict[str, Any] = Body({}, description="Data for creating advanced_template_marketplace"),
    ...
    try:
        ...
        service = get_advanced_template_marketplace_service()
        result = await service.create_advanced_template_marketplace(data)
...
@router.get("/")
async def list_advanced_template_marketplaces(
    ...
    try:
        service = get_advanced_template_marketplace_service()
        result = await service.list_advanced_template_marketplaces(
...
@router.get("/{item_id}")
async def get_advanced_template_marketplace(
    item_id: str = Path(..., description="ID of advanced_template_marketplace"),
    current_user: dict = Depends(get_current_user)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_advanced_template_marketplace_service()
        result = await service.get_advanced_template_marketplace(item_id)
...
@router.put("/{item_id}")
async def update_advanced_template_marketplace(
    item_id: str = Path(..., description="ID of advanced_template_marketplace"),
    ...
    try:
        ...
        service = get_advanced_template_marketplace_service()
        result = await service.update_advanced_template_marketplace(item_id, data)
...
async def delete_advanced_template_marketplace(
    item_id: str = Path(..., description="ID of advanced_template_marketplace"),
    current_user: dict = Depends(get_current_user)
):
    ...
    try:
        service = get_advanced_template_marketplace_service()
        result = await service.delete_advanced_template_marketplace(item_id)
