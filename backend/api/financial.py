...
async def create_financial(
    data: Dict[str, Any] = Body({}, description="Data for creating financial"),
    ...
    try:
        ...
        service = get_financial_service()
        result = await service.create_financial(data)
...
async def get_financial(
    item_id: str = Path(..., description="ID of financial"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_financial_service()
        result = await service.get_financial(item_id)
...
async def update_financial(
    ...
    try:
        ...
        service = get_financial_service()
        result = await service.update_financial(item_id, data)
...
async def delete_financial(
    ...
    try:
        service = get_financial_service()
        result = await service.delete_financial(item_id)
