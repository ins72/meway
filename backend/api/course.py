...
async def create_course(
    data: Dict[str, Any] = Body({}, description="Data for creating course"),
    ...
    try:
        ...
        service = get_course_service()
        result = await service.create_course(data)
...
async def get_course(
    item_id: str = Path(..., description="ID of course"),
    current_user: dict = Depends(get_current_user)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_course_service()
        result = await service.get_course(item_id)
...
async def update_course(
    ...
    try:
        ...
        service = get_course_service()
        result = await service.update_course(item_id, data)
...
async def delete_course(
    ...
    try:
        service = get_course_service()
        result = await service.delete_course(item_id)
