...
async def create_monitoring(
    data: Dict[str, Any] = Body({}, description="Data for creating monitoring"),
    ...
    try:
        ...
        service = get_monitoring_service()
        result = await service.create_monitoring(data)
...
async def get_monitoring(
    item_id: str = Path(..., description="ID of monitoring"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_monitoring_service()
        result = await service.get_monitoring(item_id)
...
async def update_monitoring(
    ...
    try:
        ...
        service = get_monitoring_service()
        result = await service.update_monitoring(item_id, data)
...
async def delete_monitoring(
    ...
    try:
        service = get_monitoring_service()
        result = await service.delete_monitoring(item_id)
