...
async def create_subscription(
    data: Dict[str, Any] = Body({}, description="Data for creating subscription"),
...
async def get_subscription(
    item_id: str = Path(..., description="ID of subscription"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_subscription_service()
        result = await service.get_subscription(item_id)
...
async def update_subscription(
    ...
    try:
        ...
        service = get_subscription_service()
        result = await service.update_subscription(item_id, data)
...
async def delete_subscription(
    ...
    try:
        service = get_subscription_service()
        result = await service.delete_subscription(item_id)
