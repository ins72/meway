...
from services.business_intelligence_service import get_business_intelligence_service
import logging
...
async def health_check():
    ...
    try:
        service = get_business_intelligence_service()
...
async def create_business_intelligence(
    data: Dict[str, Any] = Body({}, description="Data for creating business_intelligence"),
    ...
    try:
        ...
        service = get_business_intelligence_service()
        result = await service.create_business_intelligence(data)
...
@router.get("/")
async def list_business_intelligences(
    ...
    try:
        service = get_business_intelligence_service()
        result = await service.list_business_intelligences(
...
async def get_business_intelligence(
    item_id: str = Path(..., description="ID of business_intelligence"),
    current_user: dict = Depends(get_current_user)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_business_intelligence_service()
        result = await service.get_business_intelligence(item_id)
...
async def update_business_intelligence(
    ...
    try:
        ...
        service = get_business_intelligence_service()
        result = await service.update_business_intelligence(item_id, data)
...
async def delete_business_intelligence(
    item_id: str = Path(..., description="ID of business_intelligence"),
    current_user: dict = Depends(get_current_user)
):
    ...
    try:
        service = get_business_intelligence_service()
        result = await service.delete_business_intelligence(item_id)
