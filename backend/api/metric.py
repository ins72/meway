...
async def create_metric(
    data: Dict[str, Any] = Body({}, description="Data for creating metric"),
    ...
    try:
        ...
        service = get_metric_service()
        result = await service.create_metric(data)
...
async def get_metric(
    item_id: str = Path(..., description="ID of metric"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_metric_service()
        result = await service.get_metric(item_id)
...
async def update_metric(
    ...
    try:
        ...
        service = get_metric_service()
        result = await service.update_metric(item_id, data)
...
async def delete_metric(
    ...
    try:
        service = get_metric_service()
        result = await service.delete_metric(item_id)
