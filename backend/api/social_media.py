"""
Social Media API
RESTful endpoints for social_media
"""
...
async def health_check():
    ...
    return {
        ...
        "message": "Social Media API is operational"
    }
...
async def create_social_media(
    ...
    try:
        ...
        result = await service.create_social_media(data)
...
async def list_social_medias(
    ...
    """List social_medias with pagination"""
    try:
        service = get_social_media_service()
        result = await service.list_social_medias(
...
async def get_social_media(
    ...
    try:
        service = get_social_media_service()
        result = await service.get_social_media(item_id)
...
async def update_social_media(
    ...
    """Update social_media by ID"""
    try:
        service = get_social_media_service()
        result = await service.update_social_media(item_id, data)
...
async def delete_social_media(
    ...
    """Delete social_media by ID"""
    try:
        service = get_social_media_service()
        result = await service.delete_social_media(item_id)
