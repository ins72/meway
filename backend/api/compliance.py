...
async def create_compliance(
    data: Dict[str, Any] = Body({}, description="Data for creating compliance"),
    ...
    try:
        ...
        service = get_compliance_service()
        result = await service.create_compliance(data)
...
async def get_compliance(
    item_id: str = Path(..., description="ID of compliance"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_compliance_service()
        result = await service.get_compliance(item_id)
...
async def update_compliance(
    ...
    try:
        ...
        service = get_compliance_service()
        result = await service.update_compliance(item_id, data)
...
async def delete_compliance(
    ...
    try:
        service = get_compliance_service()
        result = await service.delete_compliance(item_id)
