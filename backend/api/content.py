...
async def create_content(
    data: Dict[str, Any] = Body({}, description="Data for creating content"),
...
async def get_content(
    item_id: str = Path(..., description="ID of content"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_content_service()
        result = await service.get_content(item_id)
...
async def update_content(
    ...
    try:
        ...
        service = get_content_service()
        result = await service.update_content(item_id, data)
...
async def delete_content(
    ...
    try:
        service = get_content_service()
        result = await service.delete_content(item_id)
