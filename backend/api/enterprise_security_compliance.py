...
from services.enterprise_security_compliance_service import get_enterprise_security_compliance_service
import logging
...
async def health_check():
    ...
    try:
        service = get_enterprise_security_compliance_service()
...
@router.post("/")
async def create_enterprise_security_compliance(
    data: Dict[str, Any] = Body({}, description="Data for creating enterprise_security_compliance"),
    ...
    try:
        ...
        service = get_enterprise_security_compliance_service()
        result = await service.create_enterprise_security_compliance(data)
...
@router.get("/")
async def list_enterprise_security_compliances(
    ...
    try:
        service = get_enterprise_security_compliance_service()
        result = await service.list_enterprise_security_compliances(
...
@router.get("/{item_id}")
async def get_enterprise_security_compliance(
    item_id: str = Path(..., description="ID of enterprise_security_compliance"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_enterprise_security_compliance_service()
        result = await service.get_enterprise_security_compliance(item_id)
...
@router.put("/{item_id}")
async def update_enterprise_security_compliance(
    item_id: str = Path(..., description="ID of enterprise_security_compliance"),
    ...
    try:
        ...
        service = get_enterprise_security_compliance_service()
        result = await service.update_enterprise_security_compliance(item_id, data)
...
async def delete_enterprise_security_compliance(
    item_id: str = Path(..., description="ID of enterprise_security_compliance"),
    current_user: dict = Depends(get_current_admin)
):
    ...
    try:
        service = get_enterprise_security_compliance_service()
        result = await service.delete_enterprise_security_compliance(item_id)
