...
async def create_preference(
    data: Dict[str, Any] = Body({}, description="Data for creating preference"),
    ...
    try:
        ...
        service = get_preference_service()
        result = await service.create_preference(data)
...
async def list_preferences(
    ...
    try:
        service = get_preference_service()
        result = await service.list_preferences(
...
async def get_preference(
    item_id: str = Path(..., description="ID of preference"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_preference_service()
        result = await service.get_preference(item_id)
...
async def update_preference(
    ...
    try:
        ...
        service = get_preference_service()
        result = await service.update_preference(item_id, data)
...
async def delete_preference(
    ...
    try:
        service = get_preference_service()
        result = await service.delete_preference(item_id)
