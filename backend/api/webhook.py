...
async def create_webhook(
    data: Dict[str, Any] = Body({}, description="Data for creating webhook"),
...
async def get_webhook(
    item_id: str = Path(..., description="ID of webhook"),
    current_user: dict = Depends(get_current_user)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_webhook_service()
        result = await service.get_webhook(item_id)
...
async def update_webhook(
    ...
    try:
        ...
        service = get_webhook_service()
        result = await service.update_webhook(item_id, data)
...
async def delete_webhook(
    ...
    try:
        service = get_webhook_service()
        result = await service.delete_webhook(item_id)
