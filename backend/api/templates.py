...
async def create_templates(
    ...
    try:
        ...
        service = get_templates_service()
        result = await service.create_templates(data)
...
async def list_templatess(
    ...
    try:
        service = get_templates_service()
        result = await service.list_templatess(
...
async def get_templates(
    ...
    try:
        service = get_templates_service()
        result = await service.get_templates(item_id)
...
async def update_templates(
    ...
    try:
        ...
        service = get_templates_service()
        result = await service.update_templates(item_id, data)
...
async def delete_templates(
    ...
    try:
        service = get_templates_service()
        result = await service.delete_templates(item_id)
