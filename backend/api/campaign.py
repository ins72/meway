...
async def create_campaign(
    data: Dict[str, Any] = Body({}, description="Data for creating campaign"),
    ...
    try:
        ...
        service = get_campaign_service()
        result = await service.create_campaign(data)
...
async def get_campaign(
    item_id: str = Path(..., description="ID of campaign"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_campaign_service()
        result = await service.get_campaign(item_id)
...
async def update_campaign(
    ...
    try:
        ...
        service = get_campaign_service()
        result = await service.update_campaign(item_id, data)
...
async def delete_campaign(
    ...
    try:
        service = get_campaign_service()
        result = await service.delete_campaign(item_id)
