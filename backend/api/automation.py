...
async def create_automation(
    data: Dict[str, Any] = Body({}, description="Data for creating automation"),
    ...
    try:
        ...
        service = get_automation_service()
        result = await service.create_automation(data)
...
async def get_automation(
    item_id: str = Path(..., description="ID of automation"),
    current_user: dict = Depends(get_current_user)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_automation_service()
        result = await service.get_automation(item_id)
...
async def update_automation(
    ...
    try:
        ...
        service = get_automation_service()
        result = await service.update_automation(item_id, data)
...
async def delete_automation(
    ...
    try:
        service = get_automation_service()
        result = await service.delete_automation(item_id)
