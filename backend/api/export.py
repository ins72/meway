...
async def create_export(
    data: Dict[str, Any] = Body({}, description="Data for creating export"),
    ...
    try:
        ...
        service = get_export_service()
        result = await service.create_export(data)
...
async def get_export(
    item_id: str = Path(..., description="ID of export"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_export_service()
        result = await service.get_export(item_id)
...
async def update_export(
    ...
    try:
        ...
        service = get_export_service()
        result = await service.update_export(item_id, data)
...
async def delete_export(
    ...
    try:
        service = get_export_service()
        result = await service.delete_export(item_id)
