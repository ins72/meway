...
async def create_integration(
    data: Dict[str, Any] = Body({}, description="Data for creating integration"),
...
async def get_integration(
    item_id: str = Path(..., description="ID of integration"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_integration_service()
        result = await service.get_integration(item_id)
...
async def update_integration(
    ...
    try:
        ...
        service = get_integration_service()
        result = await service.update_integration(item_id, data)
...
async def delete_integration(
    ...
    try:
        service = get_integration_service()
        result = await service.delete_integration(item_id)
