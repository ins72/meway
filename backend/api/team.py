...
async def create_team(
    data: Dict[str, Any] = Body({}, description="Data for creating team"),
    ...
    try:
        ...
        service = get_team_service()
        result = await service.create_team(data)
...
@router.get("/{item_id}")
async def get_team(
    item_id: str = Path(..., description="ID of team"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_team_service()
        result = await service.get_team(item_id)
...
async def update_team(
    ...
    try:
        ...
        service = get_team_service()
        result = await service.update_team(item_id, data)
...
async def delete_team(
    ...
    try:
        service = get_team_service()
        result = await service.delete_team(item_id)
