...
async def create_payment(
    data: Dict[str, Any] = Body({}, description="Data for creating payment"),
...
async def get_payment(
    item_id: str = Path(..., description="ID of payment"),
    current_user: dict = Depends(get_current_user)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_payment_service()
        result = await service.get_payment(item_id)
...
async def update_payment(
    ...
    try:
        ...
        service = get_payment_service()
        result = await service.update_payment(item_id, data)
...
async def delete_payment(
    ...
    try:
        service = get_payment_service()
        result = await service.delete_payment(item_id)
