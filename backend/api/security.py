...
async def create_security(
    data: Dict[str, Any] = Body({}, description="Data for creating security"),
    ...
    try:
        ...
        service = get_security_service()
        result = await service.create_security(data)
...
async def list_securitys(
    ...
    try:
        service = get_security_service()
        result = await service.list_securitys(
...
async def get_security(
    item_id: str = Path(..., description="ID of security"),
    current_user: dict = Depends(get_current_admin)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_security_service()
        result = await service.get_security(item_id)
...
async def update_security(
    ...
    try:
        ...
        service = get_security_service()
        result = await service.update_security(item_id, data)
...
async def delete_security(
    ...
    try:
        service = get_security_service()
        result = await service.delete_security(item_id)
