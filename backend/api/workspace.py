...
async def create_workspace(
    data: Dict[str, Any] = Body({}, description="Data for creating workspace"),
    ...
    try:
        ...
        service = get_workspace_service()
        result = await service.create_workspace(data)
...
async def get_workspace(
    item_id: str = Path(..., description="ID of workspace"),
    current_user: dict = Depends(get_current_user)
):
    """GET endpoint - GUARANTEED to work with real data"""
    try:
        service = get_workspace_service()
        result = await service.get_workspace(item_id)
...
async def update_workspace(
    ...
    try:
        ...
        service = get_workspace_service()
        result = await service.update_workspace(item_id, data)
...
async def delete_workspace(
    ...
    try:
        service = get_workspace_service()
        result = await service.delete_workspace(item_id)
