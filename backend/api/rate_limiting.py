...
Generated automatically to pair with rate_limiting_service
"""
...
async def create_item(
    ...
    """Create new item"""
    try:
        result = await rate_limiting_service.create_item(
...
async def list_items(
    ...
    """List user's items"""
    try:
        result = await rate_limiting_service.list_items(
            user_id=current_user["_id"],
            page=page,
            limit=limit
        )
...
async def get_item(
    ...
    """Get specific item"""
    try:
        result = await rate_limiting_service.get_item(
            user_id=current_user["_id"],
            item_id=item_id
        )
...
async def update_item(
    ...
    try:
        result = await rate_limiting_service.update_item(
            user_id=current_user["_id"],
            item_id=item_id,
...
async def delete_item(
    ...
    """Delete item"""
    try:
        result = await rate_limiting_service.delete_item(
            user_id=current_user["_id"],
            item_id=item_id
        )
